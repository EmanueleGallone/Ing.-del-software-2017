package provaGab.cranio.resources;

import java.util.HashMap;

import provaGab.cranio.resources.list.Coin;
import provaGab.cranio.resources.list.FaithPoint;
import provaGab.cranio.resources.list.MilitaryPoint;
import provaGab.cranio.resources.list.Servant;
import provaGab.cranio.resources.list.Stone;
import provaGab.cranio.resources.list.VictoryPoint;
import provaGab.cranio.resources.list.Wood;
