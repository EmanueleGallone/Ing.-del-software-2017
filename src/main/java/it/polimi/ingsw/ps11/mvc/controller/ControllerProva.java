...
import it.polimi.ingsw.ps11.mvc.view.TextualViewProva;

public class ControllerProva implements EventListener<ConsoleInputEvent>{
	
	
	private Game model;
	private TextualViewProva view;

	public ControllerProva(Model model, TextualViewProva view) {
