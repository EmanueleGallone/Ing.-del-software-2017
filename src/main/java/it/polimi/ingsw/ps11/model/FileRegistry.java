...
public class FileRegistry {
	...
	public static final String territoriesAction = root + "actions" + File.separatorChar + "territories";
	public static final String charactersAction = root + "actions" + File.separatorChar + "characters";
}
