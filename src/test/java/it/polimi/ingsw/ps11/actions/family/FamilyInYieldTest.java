...
//>>>>>>> 82987cfac442955eab8507997141a4aa6c23c24d
	...
	public void isLegalTest(){
		...
		FamilyInYieldAction familyInYieldAction1 = new FamilyInYieldAction(getActionManager(player1, gameLogic), harvest, neutralFamilyMember);
	...
	public void performTest(){
		...
		FamilyMember orangeFamilyMember = new OrangeFamilyMember().set(player1.getFamilyManager());
		FamilyInYieldAction familyInYieldAction1 = new FamilyInYieldAction(getActionManager(player1, gameLogic), harvest, orangeFamilyMember);
